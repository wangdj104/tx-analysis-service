    ...
    <template v-else>
      ...
      <el-tabs v-model="tab" class="workspace">
        ...
        <el-tab-pane v-if="availableTabs.includes('schedule')" label="Dialysis Schedule" name="schedule">
          <el-alert class="schedule-tip" title="The demo schedule includes the remaining sessions this month and recurring sessions next month. Each entry can be edited or cancelled." type="info" :closable="false" show-icon />
