...
import { localDateKey, localDateTimeKey, replaceTarget } from '../src/utils/familyHealth.js'
...
test('medication administration time is padded and uses the local day', () => {
  process.env.TZ = 'Asia/Shanghai'
  assert.equal(localDateTimeKey(new Date('2026-01-02T03:04:05+08:00')), '2026-01-02 03:04:05')
})
